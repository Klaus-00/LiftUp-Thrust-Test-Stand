...
// Oggetti per il motore e le bilance
Servo esc;
HX711 scale_left, scale_right, scale_thrust;

// Variabili globali
int pwm_min_percent = 30; // Percentuale minima di PWM
int pwm_max_percent = 50; // Percentuale massima di PWM
int pwm_min = 1100; // PWM minimo
int pwm_max = 2000; // PWM massimo
...
const int double_click_interval = 500; // Tempo massimo per un doppio clic
bool waiting_for_second_click = false; // Stato di attesa per il doppio clic
bool button_state = false; // Stato attuale del pulsante
bool last_button_state = false; // Stato precedente del pulsante

// Variabili per calibrazione bilance
